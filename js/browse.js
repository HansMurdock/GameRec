...
const gamePool = [
  // Page 1 — Action
  {
    id: 1,
    slug: "cyberpunk-2077",
    title: "Neon Horizon: Zero",
    tags: ["action", "pc"],
    score: 89,
    date: "Released Oct 2024",
  },
  {
    id: 2,
    slug: "elden-ring",
    title: "Elders of Mythos",
    tags: ["rpg", "ps5"],
    score: 94,
    date: "Released Sep 2024",
  },
  {
    id: 3,
    ...
    tags: ["simulation", "pc"],
    score: 82,
    date: "Released Aug 2024",
  },
  {
    id: 4,
    slug: "dark-souls-iii",
    title: "Soul Reaver: Arisen",
    tags: ["horror", "multi"],
    score: 97,
    date: "Released Oct 2024",
  },
  {
    ...
    tags: ["action", "console"],
    score: 76,
    date: "Released Jul 2024",
  },
  {
    id: 6,
    slug: "hollow-knight",
    title: "Pixel Quest: Origin",
    tags: ["indie", "switch"],
    score: 88,
    date: "Released Jun 2024",
  },
  {
    id: 7,
    slug: "sekiro-shadows-die-twice",
    title: "Shadow of the Grove",
    tags: ["adventure", "multi"],
    score: 91,
    date: "Released Sep 2024",
  },
  {
  ...
  },
  {
    id: 32,
    slug: "alan-wake-2",
    title: "Darkwave Descent",
    tags: ["horror", "adventure"],
    score: 89,
    date: "Released Nov 2022",
  },
  ...
  setTimeout(() => {
    ...
    games.forEach((g) => {
      const tagsHtml = g.tags
        .map(
          (t) =>
            `<span class="game-tag ${tagClassMap[t] || "tag-pc"}">${t.toUpperCase()}</span>`,
        )
        .join("");
      const uid = `gc-${g.id}`;
...
function initPlatformFilters() {
  document.querySelectorAll(".platform-cb").forEach((cb) => {
    cb.addEventListener("change", () => {
      state.platforms = Array.from(
        document.querySelectorAll(".platform-cb:checked"),
      ).map((el) => el.value);
      state.currentPage = 1;
      updateResultsBar();
      renderGrid();
  ...
  document.querySelectorAll(".genre-pill-filter").forEach((pill) => {
    pill.addEventListener("click", () => {
      ...
      state.genres = Array.from(
        document.querySelectorAll(".genre-pill-filter.active"),
